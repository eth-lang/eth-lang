...
(function () {
  ...
  var UNARYOPERATORS = {
    "!": "!", "void": "void", "typeof": "typeof", "delete": "delete"
  };
  var MACROSYNTAX = {
    "'": "quote", "`'": "quasi-quote", "~": "unquote", "~@": "unquote-splicing"
  };
  __eth__module.BINARYOPERATORS = BINARYOPERATORS;
  __eth__module.UNARYOPERATORS = UNARYOPERATORS;
  __eth__module.MACROSYNTAX = MACROSYNTAX;
  (function () {
  ...
  (function () {
    if (((typeof window) !== "undefined")) {
      return window["eth/compiler/constants"] = __eth__module;
    } else {
      return (void 0);
    }
  }.call(this));
