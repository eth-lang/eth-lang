...
(function () {
  ...
  var newRun = require("../testing").newRun,run = require("../testing").run,test = require("../testing").test,assert = require("../testing").assert,assertEqual = require("../testing").assertEqual;
  ...
  (function () {
    if (((typeof window) !== "undefined")) {
      return window["eth/tests/core"] = __eth__module;
    } else {
      return (void 0);
    }
  }.call(this));
